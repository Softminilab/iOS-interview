...
graph TD
    ...
    %% Optimization: LinkedList to Red-Black Tree %%
    Note over L3, L3_1, L3_2: If this chain becomes too long (e.g., > 8), convert it to a Red-Black Tree for O(log n) operations.
```
